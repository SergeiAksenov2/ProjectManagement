...
public interface ProjectManagerRole {
    ...
    @EntityAttributePolicy(entityClass = User.class, attributes = {"id", "version", "username", "password", "email", "active", "timeZoneId", "avatar"}, action = EntityAttributePolicyAction.VIEW)
